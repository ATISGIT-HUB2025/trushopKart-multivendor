...
use App\Http\Controllers\Backend\VendorAccessManagementController;
...
Route::prefix('access-management')->group(function () {
    Route::get('/', [VendorAccessManagementController::class, 'index'])->name('accessmanagement.index');
    Route::get('/create', [VendorAccessManagementController::class, 'create'])->name('accessmanagement.create');
    Route::post('/store', [VendorAccessManagementController::class, 'store'])->name('accessmanagement.store');
    Route::get('/edit/{id}', [VendorAccessManagementController::class, 'edit'])->name('accessmanagement.edit');
    Route::put('/update/{id}', [VendorAccessManagementController::class, 'update'])->name('accessmanagement.update');
    Route::delete('/destroy/{id}', [VendorAccessManagementController::class, 'destroy'])->name('accessmanagement.destroy');
});
