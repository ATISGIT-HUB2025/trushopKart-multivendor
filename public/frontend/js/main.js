$(function () {
    ...
    // Admission terms agreement functionality
    $(document).ready(function () {
        $("#agreeTerms").change(function () {
            $("#proceedButton").prop("disabled", !$(this).is(":checked"));
        });
    ...
    $(".admission-btn").hover(
        function () {
            $(this).find(".admission-icon i").addClass("fa-bounce");
        },
        function () {
            $(this).find(".admission-icon i").removeClass("fa-bounce");
        }
    );
