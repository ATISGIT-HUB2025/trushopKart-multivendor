                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="text-muted mb-1">State Head</h6>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="text-muted mb-1">State Head</h6>
                                <h3 class="mb-0">{{ $totalPurchasePrice }}</h3>
                            </div>
                        </div>
                        <div class="progress mt-3" style="height: 5px">
                ...
                <div class="card stat-card border-0 shadow-lg">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h6 class="text-muted mb-1">Today's Orders</h6>
                                <h6 class="text-muted mb-1">Divisional Head</h6>
                                <h3 class="mb-0">{{ $divisionalHeadTodaysOrders }}</h3>
                            </div>
                        </div>
                        <div class="progress mt-3" style="height: 5px">
                            <div class="progress-bar bg-primary" style="width: 75%"></div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h6 class="text-muted mb-1">Pending Orders</h6>
                                <h6 class="text-muted mb-1">Divisional Head</h6>
                                <h3 class="mb-0">{{ $divisionalHeadPendingOrders }}</h3>
                            </div>
                        </div>
                        <div class="progress mt-3" style="height: 5px">
                            <div class="progress-bar bg-warning" style="width: 65%"></div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h6 class="text-muted mb-1">Total Orders</h6>
                                <h6 class="text-muted mb-1">Divisional Head</h6>
                                <h3 class="mb-0">{{ $divisionalHeadOrders }}</h3>
                            </div>
                        </div>
                        <div class="progress mt-3" style="height: 5px">
                            <div class="progress-bar bg-success" style="width: 85%"></div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h6 class="text-muted mb-1">Total Earnings</h6>
                                <h6 class="text-muted mb-1">Divisional Head</h6>
                                <h3 class="mb-0">{{ $divisionalHeadTotalPurchasePrice }}</h3>
                            </div>
                        </div>
                        <div class="progress mt-3" style="height: 5px">
                            <div class="progress-bar bg-info" style="width: 70%"></div>
