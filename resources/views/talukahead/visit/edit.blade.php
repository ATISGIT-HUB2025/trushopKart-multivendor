...
<section id="wsus__dashboard">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">Edit School Visit</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('taluka.visit.update', $visit->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('school_name') is-invalid @enderror" 
                                id="school_name" name="school_name" value="{{ old('school_name', $visit->school_name) }}" required>
                            @error('school_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('total_book_order') is-invalid @enderror" 
                                id="total_book_order" name="total_book_order" value="{{ old('total_book_order', $visit->total_book_order) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('total_book_payment') is-invalid @enderror" 
                                id="total_book_payment" name="total_book_payment" value="{{ old('total_book_payment', $visit->total_book_payment) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('total_admission') is-invalid @enderror" 
                                id="total_admission" name="total_admission" value="{{ old('total_admission', $visit->total_admission) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('total_admission_payment') is-invalid @enderror" 
                                id="total_admission_payment" name="total_admission_payment" value="{{ old('total_admission_payment', $visit->total_admission_payment) }}" required>
