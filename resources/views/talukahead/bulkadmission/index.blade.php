                    ...
                    <div class="container">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{ route('taluka.bulkadmission') }}" class="btn btn-primary me-2">
                                        Bulk Admission
                                    </a>
                                ...
                                <table class="table table-bordered" id="admissionTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('taluka.bulkadmission.view', $student->id) }}" class="btn btn-sm btn-success">View</a>
                                                <a href="{{ route('taluka.bulkadmission.edit', $student->id) }}" class="btn btn-sm btn-info">Edit</a>
    ...
    $(document).ready(function() {
        ...
        $('.delete-btn').on('click', function() {
            if (confirm('Are you sure you want to delete this student?')) {
                let id = $(this).data('id');
                $.ajax({
                    url: `/taluka/bulkadmissiondelete/${id}`,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
