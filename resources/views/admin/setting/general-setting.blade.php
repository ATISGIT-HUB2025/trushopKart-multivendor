...
<div class="card border">
    <div class="card-body">
        <form action="{{route('admin.generale-setting-update')}}" method="POST">
            ...
            <div class="form-group">
                <label>Mpoint Inr Value</label>
                <input type="text" class="form-control" name="mpoint_value" value="{{@$generalSettings->mpoint_value}}">
            </div>

              <div class="form-group">
                <label>Per Refer Points</label>
                <input type="text" class="form-control" name="refer_points" value="{{@$generalSettings->refer_points}}">
            </div>
