    ...
    <div class="section-body">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="text-end">
                    <a href="{{ route('admin.result.index') }}" class="btn btn-secondary">Back to List</a>
                    <a href="{{ route('admin.result.edit', $primaryresult->id) }}" class="btn btn-primary">Edit Result</a>
                </div>
            </div>
        </div>
    </div>
