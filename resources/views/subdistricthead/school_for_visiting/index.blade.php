            ...
            <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
                <div class="dashboard_content mt-2 mt-md-0">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('subdistrict.school-for-visiting.create') }}" class="btn btn-primary">
...
<div class="modal fade" id="uploadExcelModal" tabindex="-1" aria-labelledby="uploadExcelModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="excelUploadForm" action="{{route('subdistrict.school-for-visiting.excel')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('subdistrict.school-for-visiting.edit', $schoolForVisiting->id) }}"
                                                        class="btn btn-sm btn-outline-primary">
                                                        <i class="fas fa-edit me-1"></i>Edit
                                                    </a>
                                                    <form action="{{ route('subdistrict.school-for-visiting.destroy', $schoolForVisiting->id) }}"
