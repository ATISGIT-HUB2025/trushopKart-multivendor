                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h3 class="mb-0">{{ $districtHeadTodaysOrders }}</h3>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h3 class="mb-0">{{ $districtHeadPendingOrders }}</h3>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h3 class="mb-0">{{ $districtHeadOrders }}</h3>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h6 class="text-muted mb-1">Total Earnings</h6>
                                <h6 class="text-muted mb-1">District Head</h6>
                                <h3 class="mb-0">{{ $districtHeadTotalPurchasePrice }}</h3>
