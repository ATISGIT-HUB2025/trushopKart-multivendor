                ...
                <div class="dashboard_content mt-2 mt-md-0">
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('divisional_head.accessmanagement.update', $employee->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row g-4">
                                    <div class="col-md-6">
                                ...
                                <div class="mt-4 d-flex gap-3">
                                    ...
                                    <a href="{{ route('divisional_head.accessmanagement.index') }}" class="btn btn-light px-4">
