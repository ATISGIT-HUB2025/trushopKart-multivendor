...
<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      {{-- <li><a class="{{ setActive(['vendor.accessmanagement.*']) }}" href="{{ route('vendor.accessmanagement.index') }}"><i class="fas fa-users"></i> Access Management</a></li> --}}
      ...
      <li><a class="{{setActive(['vendor.shop-profile.index'])}}" href="{{route('vendor.shop-profile.index')}}"><i class="far fa-user"></i>Company Profile</a></li>
      <li><a class="{{setActive(['vendor.profile'])}}" href="{{route('vendor.profile')}}"><i class="far fa-user"></i> My Profile</a></li><li>
      <li><a class="{{setActive(['vendor.bank'])}}" href="{{route('vendor.bank')}}"><i class="far fa-university"></i>Bank Update</a></li><li>
