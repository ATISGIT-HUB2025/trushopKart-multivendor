                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="wsus__contact_single">
                                    ...
                                    <h5>phone number</h5>
                                    @php
    $cleanPhone = preg_replace('/\D/', '', @$settings->contact_phone); // Keep only digits
@endphp

                                    <a href="https://wa.me/{{ $cleanPhone }}">{{@$settings->contact_phone}}</a>
                            ...
                            <form id="contact-form">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <button type="submit" class="common_btn button_yy" id="form-submit">send now</button>
                                    </div>
                                </div>
                            </form>
                        </div>
