    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-5 col-3 col-md-3 col-lg-6">
                 <ul class="wsus__mobile_menu_header_icon d-inline-flex d-md-none me-auto float-end">
        ...
        <li><a href="{{route('teacher.dashboard')}}"><i class="fal fa-user"></i></a></li>
                ...
                <div class="wsus__call_icon_area">
                    <div class="wsus__call_area">
                        ...
                        <div class="wsus__call_text">
                            <p><i class="fa-solid fa-envelope"></i> {{$settings->contact_email}}</p>
                            <p><i class="fa-solid fa-phone"></i> {{$settings->contact_phone}}</p>
                        </div>
                    </div>
