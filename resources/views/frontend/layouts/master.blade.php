...
<head>
    ...
    <link rel="stylesheet" href="{{asset('frontend/css/style.css?v=1.221212')}}">
    <link rel="stylesheet" href="{{asset('frontend/css/responsive.css?v=?v=1.222')}}">
...
<body>
    ...
    <!--main/custom js-->
    <script src="{{asset('frontend/js/main.js?v=1.222')}}"></script>
