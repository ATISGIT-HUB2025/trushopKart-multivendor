        ...
        <div class="row justify-content-between">
            <div class="col-xl-3 col-sm-7 col-md-6 col-lg-3">
                <div class="wsus__footer_content">
                    ...
                    @php
    $cleanPhone = preg_replace('/\D/', '', @$footerInfo->phone); // Keep only digits
@endphp

                    <a class="action" href="https://wa.me/{{ $cleanPhone }}"><i class="fas fa-phone-alt"></i>{{@$footerInfo->phone}}</a>
                ...
                <div class="wsus__footer_content">
                    ...
                    <ul class="wsus__footer_menu">
                        @foreach ($footerGridThreeLinks as $link)
                            <li><a href="{{$link->url}}"><i class="fas fa-caret-right"></i> {{$link->name}}</a></li>
                        @endforeach
                        {{-- <li><a class="{{setActive(['contact'])}}" href="{{route('request_access')}}"><i class="fas fa-caret-right"></i>Request Partner Access</a></li> --}}
                    </ul>
                </div>
            </div>
