...
<body>
    ...
    function getBase64Image($imagePath) {
        ...
        return ''; 
            ...
            $base64Logo_A = getBase64Image(@$masterInfo->logo ?: 'default_logo.png');
            $base64Logo_B = getBase64Image(@$masterInfo->logo_2 ?: 'default_logo.png');
            $base64AdminSig = getBase64Image(@$masterInfo->director2_sign);
            $base64DirectorSig = getBase64Image(@$masterInfo->director1_sign);
            ...
            <img src="{{ $base64Logo_A }}"  alt="Award Icon" />
            <img src="{{ $base64Logo_B }}" alt="Logo" />
    ...
    <table>
        ...
        @php
            ...
            switch($primaryResult->std) {
                ...
                case '7':
                case '8':
                    $paperOneMaxMarks = $masterInfo->paper1_marks ?? null;;
                    $paperTwoMaxMarks = $masterInfo->paper2_marks ?? null;;
                    break;
            }
        ...
        <div style="width: 100%; text-align: center; margin-top: 20px;">
            ...
            <div style="display: inline-block; width: 25%; margin-top:20px; text-align: center; vertical-align: top; margin: 0 60px;">
              ...
              @endif
               ...
               {{$masterInfo->director2_name ?? ''}}<br />(ADMINISTRATOR)
                </div>
            </div>
            <!-- Second Group -->
            <div style="display: inline-block; width: 25%; text-align: center; vertical-align: top; margin: 0 80px;">
                <div style="margin: 0 10px;">
                @if($base64DirectorSig)
                  <img src="{{ $base64DirectorSig }}" alt="Administrator Signature" style="width: 120px;" />
              @endif
                </div>
                <div style="width: 100%; border-top: 2px solid black; padding-top: 5px; font-size: 14px;">
                {{$masterInfo->director1_name ?? ''}}<br />(DIRECTOR)
                </div>
            </div>
        </div>
