...
class DivisionHeadBulkImportController extends Controller
{
    public function index()
    {
        // return 'ok';
        $students = StudentAdmission::where('teacher_id', auth()->id())->get();
        return view('divisional_head.bulk-admission.index', compact('students'));
    }

    public function create()
    {
        return view('divisional_head.bulk-admission.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('divisional_head.bulk-admission.index');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('divisional_head.bulk-admission.edit', compact('student'));
    }

    public function show($id)
{
    $student = StudentAdmission::findOrFail($id);
    return view('divisional_head.bulk-admission.view', compact('student'));
}
    ...
    public function generateTickets()
    {
        ...
        $pdf = PDF::loadView('divisional_head.bulk-admission.hall-ticket-pdf', compact('students'))
            ->setPaper('a4')
            ->setOptions([
