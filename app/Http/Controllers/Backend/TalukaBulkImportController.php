...
class TalukaBulkImportController extends Controller
{
    public function index()
    {
        // return 'ok';
        $students = StudentAdmission::where('teacher_id', auth()->id())->get();
        return view('talukahead.bulk-admission.index', compact('students'));
    }

    public function create()
    {
        return view('talukahead.bulk-admission.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('taluka.bulk-admission.index');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('talukahead.bulk-admission.edit', compact('student'));
    }

    public function show($id)
{
    $student = StudentAdmission::findOrFail($id);
    return view('talukahead.bulk-admission.view', compact('student'));
}
    ...
    public function generateTickets()
    {
        ...
        $pdf = PDF::loadView('talukahead.bulk-admission.hall-ticket-pdf', compact('students'))
            ->setPaper('a4')
            ->setOptions([
