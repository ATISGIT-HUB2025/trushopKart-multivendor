...
class DistrictHeadBulkImportController extends Controller
{
    public function index()
    {
        // return 'ok';
        $students = StudentAdmission::where('teacher_id', auth()->id())->get();
        return view('districthead.bulk-admission.index', compact('students'));
    }

    public function create()
    {
        return view('districthead.bulk-admission.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('district.bulk-admission.index');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('districthead.bulk-admission.edit', compact('student'));
    }

    public function show($id)
{
    $student = StudentAdmission::findOrFail($id);
    return view('districthead.bulk-admission.view', compact('student'));
}
    ...
    public function generateTickets()
    {
        ...
        $pdf = PDF::loadView('districthead.bulk-admission.hall-ticket-pdf', compact('students'))
            ->setPaper('a4')
            ->setOptions([
