...
class PhotoGalleryDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                $editBtn = "<a href='" . route('admin.photo-gallery.edit', $query->id) . "' class='btn btn-primary'><i class='far fa-edit'></i></a>";

                $deleteBtn = "
                <form method='POST' action='" . route('admin.photo-gallery.destroy', $query->id) . "' style='display:inline-block;' onsubmit='return confirm(\"Are you sure you want to delete this?\");'>
                    " . csrf_field() . "
    ...
    public function query(PhotoShop $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('photo_gallery-table')
    ...
    {
        return 'PhotoGallery_' . date('YmdHis');
    }
}
